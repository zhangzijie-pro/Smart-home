...
BlinkerButton Buttonfl1("btn-fl1");
BlinkerButton Buttonfl2("btn-fl2");
BlinkerButton Buttonfl3("btn-fl3");
BlinkerButton Buttonfl4("btn-fl4");

BlinkerNumber Number1("num-temp");
BlinkerNumber Number2("num-humi");
BlinkerText tex_ok("text-ok");
...
void buttonfl1_callback(const String & state){
    if (state=="on") {
    // TODO
    sendcmd[1]=0x19;
    sendcmd[2]=0x01;
...
void buttonfl2_callback(const String & state){
    if (state=="on") {
    // TODO
    sendcmd[1]=0x19;
    sendcmd[2]=0x03;
...
void buttonfl3_callback(const String & state){
    if (state=="on") {
    // TODO
    sendcmd[1]=0x19;
    sendcmd[2]=0x05;
...
void setup()
{
    ...
    Buttonfl1.attach(buttonfl1_callback);
    Buttonfl2.attach(buttonfl2_callback);
    Buttonfl3.attach(buttonfl3_callback);
